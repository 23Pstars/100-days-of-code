...
2. Fork this repo and commit to the [Log](log.md) daily. But since forked version [doesn't count as contribution](https://help.github.com/articles/why-are-my-contributions-not-showing-up-on-my-profile/#commit-was-made-in-a-fork) in your profile, you recommended to clone this repo and commit to your new repo.
